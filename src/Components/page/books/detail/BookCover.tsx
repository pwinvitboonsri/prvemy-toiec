      ...
      >
        <div className="relative h-full  overflow-hidden ">
          ...
          <div className="relative h-full ">
            <div className="absolute bottom-0 left-0 top-0 z-20 w-3 md:w-4 border-r border-[#111111] bg-black/20"></div>

            <div
              className={cn(
                "relative z-10 flex h-full flex-col items-center justify-center text-[#f2f0e9] mix-blend-screen transition-all duration-300",
                isHovered ? "blur-[2px] opacity-50" : "blur-0 opacity-100"
              )}
            >
              <div className="mb-4 border-4 border-[#f2f0e9] p-4 md:p-6 text-center">
          ...
          <div
            className={cn(
              "absolute inset-0 z-30 flex flex-col bg-[#f2f0e9] text-[#111111] transition-transform duration-300",
          ...
          >
            <div className="flex-1 flex flex-col p-3">
              <div className="space-y-1 shrink-0">
                ...
                <div className="h-0.5 w-full bg-[#111111] mt-2"></div>
              </div>

              <div className="flex-1 flex flex-col justify-end space-y-4 font-mono text-xs md:text-sm font-bold py-4">
                <div className="flex items-end justify-between border-b-2 border-dashed border-[#111111]/20 pb-2">
            ...
            <div className="shrink-0">
              <div className="bg-[#ffe800] py-3 px-4 text-center text-[10px] md:text-xs font-black uppercase tracking-widest border-t-2 border-[#111111]">
